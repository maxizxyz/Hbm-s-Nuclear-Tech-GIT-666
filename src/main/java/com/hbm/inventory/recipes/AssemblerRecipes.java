...
@Deprecated public class AssemblerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_radar_p35, 1), new AStack[] {new OreDictStack(STEEL.plateWelded(), 8), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 6), new OreDictStack(ANY_PLASTIC.ingot(), 24), new OreDictStack(ANY_RUBBER.ingot(), 24), new ComparableStack(ModItems.magnetron, 16), new ComparableStack(ModItems.motor_desh, 2), new ComparableStack(ModItems.circuit, 6, EnumCircuitType.ADVANCED), new ComparableStack(ModItems.coil_copper, 48), new ComparableStack(ModItems.crt_display, 6), },800);
