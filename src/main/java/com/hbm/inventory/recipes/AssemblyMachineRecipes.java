...
public class AssemblyMachineRecipes extends GenericRecipes<GenericRecipe> {
	...
	public void registerDefaults() {
		...
		*/
		...
		this.register(new GenericRecipe("ass.radarp35").setup(600, 100).outputItems(new ItemStack(ModBlocks.machine_radar_p35, 1))
				.inputItems(new OreDictStack(STEEL.plateWelded(), 8), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 6), new OreDictStack(ANY_RUBBER.ingot(), 32), new ComparableStack(ModItems.magnetron, 20), new ComparableStack(ModItems.motor_desh, 2), new ComparableStack(ModItems.circuit, 6, EnumCircuitType.ADVANCED), new ComparableStack(ModItems.crt_display, 6))
				.inputItemsEx(new ComparableStack(ModItems.item_expensive, 6, EnumExpensiveType.HEAVY_FRAME), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 10), new OreDictStack(ANY_RUBBER.ingot(), 32), new ComparableStack(ModItems.magnetron, 20), new ComparableStack(ModItems.motor_desh, 4), new ComparableStack(ModItems.item_expensive, 8, EnumExpensiveType.CIRCUIT), new ComparableStack(ModItems.crt_display, 6)));
