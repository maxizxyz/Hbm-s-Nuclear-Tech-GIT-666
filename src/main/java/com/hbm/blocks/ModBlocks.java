...
public class ModBlocks {
	...
	public static Block machine_radar_p35;
	...
	private static void initializeBlock() {
		...
		machine_radar_p35 = new MachineRadarP35(Material.iron).setBlockName("machine_radar_p35").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.missileTab).setBlockTextureName(RefStrings.MODID + ":block_steel");
	...
	private static void registerBlock() {
		...
		GameRegistry.registerBlock(machine_radar_p35, machine_radar_p35.getUnlocalizedName());
